...
Mildred Mary Munday was born on 25 April 1884 in Surbiton, Surrey to  John Hill Munday (\p{John_Hill_Munday}) and Catherine Aldridge (\p{Catherine_Aldridge}), and was christened on 15 August 1885 at St Marks, Surbiton, Surrey \cite{MildredMundayBirth}. She had four siblings:  Nora Katie Munday (\p{Nora_Katie_Munday}),  Kathleen Munday (\p{Kathleen_Munday}), Ralph Munday (\p{Ralph_Munday}), and Margery Munday (\p{Margery_Munday}).
