...
Nyria Denton-Barker (n\'{e}e Hancox) was born on 23 February 1918 in Bebington, Cheshire\cite{BMDIndex_JoanNyriaHancox_birth} and was the only daughter of Richard James Hancox (\p{Richard_James_Hancox})  and Marian Gilmour Croskery (\p{Marian_Gilmour_Croskery}).\cite{NyriaBirth} and was christened on 7 April 1918.\cite{NyriaChristening} She had one brother, Eric Geoffrey West Hancox (\p{Eric_Geoffrey_West_Hancox}).  They lived at 8 Thorburn Road, Rock Ferry. 

From the age of 6, she attended Howell's School, Denbigh (in \idx{Wales}).\cite{OralHistoryJDB2008}
