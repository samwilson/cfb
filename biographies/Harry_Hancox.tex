...
On 28 May 1867 he married Maria Mary Merrett (\p{Maria_Mary_Merrett}) at the church of St Stephen the Martyr in West Derby, Lancashire \cite{HarryHancoxMarriage}.  They had four children: Harry Merret Hancox (\p{Harry_Merret_Hancox}), Frank Heeley Hancox (\p{Frank_Heeley_Hancox}), Charles Edward Hancox (\p{Charles_Edward_Hancox}), and Richard James Hancox (\p{Richard_James_Hancox}).
