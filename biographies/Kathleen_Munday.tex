...
Early the following year their first son, Bertram Mead (\p{Bertram_Mead_Denton_Barker}), was born, followed a year and a half later by Ralph (\p{Ralph_Munday_Denton-Barker}), and then Virginia (\p{Virginia_Kathleen_Denton_Barker}) in 1919.
