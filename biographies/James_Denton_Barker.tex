...
James was born on the 18th July 1876 at 10 Falkner Street, Toxteth, Liverpool \cite{JamesDBarkerBirth}. His parents were Thomas Henry Barker (\p{Thomas_Henry_Barker}) and Mary Ellen Moulsdale (\p{Mary_Ellen_Moulsdale}). He was the eldest of seven and his siblings were Charles Frederick Strangways Barker (\p{Charles_Frederick_Strangeways_Barker}),  Reverend Thomas Percy Conyers Barker (\p{Thomas_Percy_Conyers_Barker}), Francis Darcy Mead Barker (\p{Francis_Darcy_Mead_Barker}), William Danby Holt Barker (\p{William_Danby_Holt_Barker}), Jonathan Tong Barker (\p{Jonathan_Tong_Barker}), and Henry Bertram Mitford Barker (\p{Henry_Bertram_Mitford_Barker}).
