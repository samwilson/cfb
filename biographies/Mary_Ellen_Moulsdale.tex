...
She married Thomas Henry Barker on 25 August 1875 at St Margarets, in Anfield, Liverpool, Lancashire \cite{MEMoulsdaleMarriage} and they lived at 10 Falkner Street, Liverpool.  They had seven sons: James Denton Barker (\p{James_Denton_Barker}), Charles Frederick Strangeways Barker (\p{Charles_Frederick_Strangeways_Barker}), Reverend Thomas Percy Conyers Barker (\p{Thomas_Percy_Conyers_Barker}), Francis Darcy Mead Barker (\p{Francis_Darcy_Mead_Barker}), William Danby Holt Barker (\p{William_Danby_Holt_Barker}), Jonathan Tong Barker (\p{Jonathan_Tong_Barker}) and Henry Bertram Mitford Barker (\p{Henry_Bertram_Mitford_Barker}).
...
\begin{figure}
 ...
 \caption{Mary Ellen with her husband and probably James (\p{James_Denton_Barker}) and Charles (\p{Charles_Frederick_Strangeways_Barker}), c.~1880.}
\end{figure}
