...
Eric Geoffrey West Hancox (or `Geoffrey' to his family) was  born in July/August 1911 in Rock Ferry\cite{EGWHbirth} to Richard James Hancox (\p{Richard_James_Hancox}) and Marian Gilmour Croskery (\p{Marian_Gilmour_Croskery}) and christened on 10 September.\cite{EGWHchristening} He had one sister, Joan Nyria Hancox (\p{Joan_Nyria_Hancox}).
