...
\usepackage{url, graphicx, wrapfig, hyperref, ifthen, enumitem, makeidx}
...
% ---- references environment, \reference command, and \citeref command
\newcounter{saveenumi}
\newenvironment{references}[0]
{
	\footnotesize \vspace{1em} \textbf{References:}
